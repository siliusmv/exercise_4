...
#knn_class = np.genfromtxt("dataset/dataset/knn_classification.csv", delimiter=",", skip_header=1)
#knn_reg = np.genfromtxt("dataset/dataset/knn_regression.csv", delimiter=",", skip_header=1)
#ada_test = np.genfromtxt("dataset/dataset/adaboost_test.csv", delimiter=",", skip_header=1)
#ada_train = np.genfromtxt("dataset/dataset/adaboost_train.csv", delimiter=",", skip_header=1)


#lines = inspect.getsourcelines(test)    
#print("".join(lines[0]))
