...
We implement tha AdaBoost algorithm from scratch. The code can be seen in the print-out below. We use the `DecisionTreeClassifier`  \textit{DecisionTreeClassifier}from `sklearn` with a miximum depth of 1 as our weak learner.
